...
*Примечание:* На русскоязычной Windows терминал по умолчанию может использовать кодировку CP866. В этом случае перед запуском рекомендутся установить кодировку терминала на UTF-8 путем ввода команды:
```
chcp 65001
```
**Параметры (флаги):**
